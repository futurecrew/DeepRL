...
class ModelTorcsLowDim(Model):
    def build_network(self, name, network, trainable, action_group_no):
        ...
        self.actor_vars = [W_actor_fc1, b_actor_fc1, W_actor_fc2, b_actor_fc2, W_steering, b_steering, W_acc, b_acc]
        if action_group_no == 3:
            self.actor_vars += [ W_brake, b_brake]
...
class ModelTorcsPixel(Model):
    def build_network(self, name, network, trainable, action_group_no):
        ...
        self.actor_y = actor_y
        self.critic_y = critic_y
        self.actor_vars = [W_conv1, b_conv1, W_conv2, b_conv2, W_conv3, b_conv3, W_fc1, b_fc1, W_fc2, b_fc2, W_steering, b_steering, W_acc, b_acc]
        if action_group_no == 3:
            self.actor_vars += [ W_brake, b_brake]
        self.critic_vars = [W_critic_fc1, b_critic_fc1, W_critic_fc3, b_critic_fc3]
